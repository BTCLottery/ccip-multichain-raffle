...
export interface LotteryReceiverInterface extends utils.Interface {
  functions: {
...
export interface LotteryReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LotteryReceiverInterface;
