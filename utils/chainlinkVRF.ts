...
export const CHAINLINK_CONFIG: ChainlinkConfig = {
    "1": {
        ...
        VRF_Coordinator: {
            ...
            maxGasLimit: 2500000,
            keyHashes: {
                "200": "0x8af398995b04c28e9951adb9721ef74c74f93e6a478f39e7e0777be13527e7ef",
                "500": "0xff8dedfbfa60af186cf3c830acbc32c05aae823045ae5ea7da1e45fbfaba4f92",
                "1000": "0x9fe0eebf5e446e3c998ec9bb19951541aee00bb90ea201ae456421a2ded86805"
            },
        },
        minConfirmations: 3,
    ...
    "56": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.005, // LINK
            keyHashes: {
                "200": "0x114f3da0a805b6a67d6e9cd2ec746f7028f1b7376365af575cfea3550dd1aa04",
                "500": "0xba6e730de88d94a5510ae6613898bfb0c3de5d16e609c5b7da808747125506f7",
                "1000": "0x17cd473250a9a479dc7f234c64332ed4bc8af9e8ded7556aa6e66d83da49f470"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 3,
    ...
    "137": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.0005, // LINK
            keyHashes: {
                "200": "0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93",
                "500": "0xcc294a196eeeb44da2888d17c0625cc88d70d9760a69d58d853ba6581a9ab0cd",
                "1000": "0xd729dc84e21ae57ffb6be0053bf2b0668aa2aaf300a2a7b2ddf7dc0bb6e875a8"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 3,
    ...
    "80001": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.0005, // LINK
            keyHashes: {
                "500": "0x4b09e658ed251bcafeebbc69400383d49f344ace09b9576fe248bb02c003fe9f"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 3,
    ...
    "43114": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.005, // LINK
            keyHashes: {
                "200": "0x83250c5584ffa93feb6ee082981c5ebe484c865196750b39835ad4f13780435d",
                "500": "0x89630569c9567e43c4fe7b1633258df9f2531b62f2352fa721cf3162ee4ecb46",
                "1000": "0x06eb0e2ea7cca202fc7c8258397a36f33d88568d2522b37aaa3b14ff6ee1b696"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 1,
    ...
    "43113": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.005, // LINK
            keyHashes: {
                "300": "0x354d2f95da55398f44b7cff77da56283d9c6c829a4bdf1bbcaf2ad6a4d081f61"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 1,
    ...
    "250": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.0005, // LINK
            keyHashes: {
                "4000": "0xb4797e686f9a1548b9a2e8c68988d74788e0c4af5899020fb0c47784af76ddfa",
                "10000": "0x5881eea62f9876043df723cf89f0c2bb6f950da25e9dfe66995c24f919c8f8ab",
                "20000": "0x64ae04e5dba58bc08ba2d53eb33fe95bf71f5002789692fe78fb3778f16121c9"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 1,
    ...
    "4002": {
        ...
        VRF_Coordinator: {
            ...
            premium: 0.0005, // LINK
            keyHashes: {
                "3000": "0x121a143066e0f2f08b620784af77cccb35c6242460b4a8ee251b4b416abaebd4"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 1,
    ...
    "42161": {
        ...
        VRF_Coordinator: {
            ...
            keyHashes: {
                ...
                "150": "0x68d24f9a037a649944964c2a1ebd0b2918f4a243d2a99701cc22b548cf2daff0"
            },
            maxGasLimit: 2500000,
        },
        minConfirmations: 1,
...
export function getKeyHashesByNetworkID(chainID: number): { [price: string]: string } | null {
...
export function getKeyHashesByChainID(chainID: number, price?: string): KeyHashes | string | null {
    const config = CHAINLINK_CONFIG[chainID];
...
// Example usage:
// const keyHashes = getKeyHashesByNetworkID(1);
// const allKeyHashes = getKeyHashesByChainID(421613);
// const specificKeyHash = getKeyHashesByChainID(421613, 50);
// console.log('specificKeyHash', specificKeyHash);
// console.log('allKeyHashes', allKeyHashes);
// console.log('keyHashes', keyHashes);
// console.log('all config -> ', getConfigByNetworkID(1))